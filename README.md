...
| [`@dg-design/react`](https://www.npmjs.com/package/@dg-design/react) | 0.9.0 | React 컴포넌트 21종 (Button, Badge, NotificationBadge, Alert, Toast, Spinner, Progress, Checkbox, Switch, TextField·Field, TextArea, RadioGroup, Select, MultiSelect, Dialog, Sheet, DropdownMenu, ContextMenu, Tooltip, Popover, HoverCard). plain CSS + CVA, Tailwind 비종속 |
