...
| [`@dg-design/react`](https://www.npmjs.com/package/@dg-design/react) | 0.6.0 | React 컴포넌트 (Button, Badge, Checkbox, Switch, TextField·Field, Dialog, DropdownMenu). plain CSS + CVA, Tailwind 비종속 |
